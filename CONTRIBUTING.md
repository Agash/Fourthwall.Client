# Contributing to Fourthwall.Client
...
```bash
dotnet restore Fourthwall.Client.slnx
dotnet build Fourthwall.Client.slnx
...
```bash
dotnet test Fourthwall.Client.slnx --filter "TestCategory!=Integration"
```
